...
from orderflow_edge_lab.cross_exchange_funding_bitget import load_symbol_dataset_bitget
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run frozen MEXC-vs-Bitget perpetual funding-dispersion research.")
    parser.add_argument("--config", default="config/last_chance_structural_edge_v1_2.json")
    ...
    def load(symbol: str):
        return symbol, load_symbol_dataset_bitget(symbol, data_start, data_end)
