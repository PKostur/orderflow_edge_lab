...
from orderflow_edge_lab.htf_fibonacci_forward_shadow import build_forward_report
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the frozen multi-coin 8h Fibonacci trend paper-shadow agent."
    )
    parser.add_argument(
        "--candidate", default="config/htf_fibonacci_forward_candidate_v1.json"
    )
