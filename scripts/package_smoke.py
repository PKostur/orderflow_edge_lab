...
assert {'orderflow-paper', 'orderflow-probe', 'orderflow-validate', 'orderflow-readiness', 'orderflow-discover-endpoint', 'orderflow-analyze-endpoint', 'orderflow-audit-causality', 'orderflow-dxfeed-login'} <= entries.keys()
